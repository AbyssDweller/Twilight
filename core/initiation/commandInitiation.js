 ...
 */
 ...
 function initiateCommands(client) {
     ...
     client.categoryID = new discord.Collection();
     ...
     fs.readdir("core/bot/client/commands", (err, dir) => {
         ...
         dir.forEach(folder => {
             fs.readdir(`core/bot/client/commands/${folder}`, (error, files) => {
                 ...
                 client.categoryID.set(categoryConfiguration.id.toUpperCase(), categoryConfiguration.name.toLowerCase());
